...
main.o: main.cpp iobject3d.h geometry.hpp ccamera.hpp ikdtree.h iparser.h clighter.hpp
	$(CC) $(CFLAGS) main.cpp iobject3d.h geometry.hpp ccamera.hpp ikdtree.h iparser.h clighter.hpp
